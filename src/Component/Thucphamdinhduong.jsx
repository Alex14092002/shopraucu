...
const Uudaihot = (props) => {
  ...
  useEffect(() => {
    fetch("https://data-banraucu-default-rtdb.firebaseio.com/thucphamdinhduong.json")
            ...
            >
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img
                    src="https://bizweb.dktcdn.net/100/416/540/files/banner-nhom-1.jpg?v=1647933629298"
                    class="d-block w-100"
                    alt="..."
                  />
                </div>
                <div class="carousel-item">
                  <img
                    src="https://bizweb.dktcdn.net/100/416/540/files/banner-nhom-2.jpg?v=1647933629676"
                    class="d-block w-100"
                    alt="..."
                  />
                </div>
                <div class="carousel-item">
                  <img
                    src="https://thucphamquocte.vn/wp-content/uploads/2021/07/banner-tpqt-06-scaled.jpg"
                    class="d-block w-100"
                    alt="..."
                  />
                </div>
        ...
        <div className="main-product row">
          {
            ...
            data.map(item => (
               ...
               <div className="item-product col-6 col-md-3">
                ...
                <Link to={`/thucphamdinhduong/${item.id}`}>
                ...
                <div className="price-cart">
                  ...
                  <div className="cart-icon">
                    <span onClick={ () => props.handleAddToCart( 'thucphamdinhduong',  item.id , item.name , item.promotionalPrice , item.img1 )}>+</span>
                  </div>
                </div>
              </div>
