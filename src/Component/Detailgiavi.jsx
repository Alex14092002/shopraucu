...
const Detailuudaihot = (props) => {
    ...
    useEffect(() => {
        fetch(`https://data-banraucu-default-rtdb.firebaseio.com/giavi/${id}.json`)
          ...
          />
            ...
            <div className="item-detail col-12 col-md-6">
                ...
                <div className="btn-detail">
                    ...
                    <Link onClick={ () => props.handleAddToCart( 'giavi',  data2.id , data2.name , data2.promotionalPrice , data2.img1 )}>Thêm Vào Giỏ</Link>
                    </div>
                </div>
